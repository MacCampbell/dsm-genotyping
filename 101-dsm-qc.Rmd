...
We should really have more SNPS. Trying this again, but, I think that maybe we should drop the low-coverage individuals some more.

```{sh, eval=FALSE}
srun -t 36:00:00 -p high --mem=32G --nodes=2 $HOME/angsd/angsd -minInd 618 -nthreads 24 \
