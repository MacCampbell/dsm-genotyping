...
Basic genotyping calling. The large amount of low-coverage individuals caused me to use a smaller dataset see 101-dsm-qc.  The meta for the samples is available at meta/samples75.csv. I checked with a PCA for funny stuff, and excluded samples (e.g. putative Wakasagis). The resulting 687 samples had genotype calls produced by ANGSD and BCFTOOLs. Here is the command used for the calls included in this document:      
